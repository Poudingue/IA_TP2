...
public class JoueurMinMaxBis implements Joueur{
    int nb_iterations = 4;//>0. Il semblerait qu'en mettre plus de 2 est inutile, à moins que ça soit juste mal implémenté
